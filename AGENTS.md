...
現行テーマ PoC は `docs/research/2026-09-05-design-prototype-03/theme/helix-wt/`。旧 AGENT NEO のテーマ・プラグインは `archive/agent-neo/` に置く参照資産であり、現行の実装・受入証拠ではない。
