...
<div class="wp-block-group alignfull an-lp-comparison has-background-background-color has-background" style="padding-top:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--40)">
	...
	<h2 class="wp-block-heading has-text-align-center" style="font-weight:700;margin-bottom:var(--wp--preset--spacing--20)">従来の運用と何が違うのか</h2>
	<!-- /wp:heading -->
	...
	<p class="has-text-align-center" style="font-size:var(--wp--preset--font-size--medium);margin-bottom:var(--wp--preset--spacing--50);color:#555555">人手に依存した旧来の運用スタイルから、AI による自律運用へ。その差は一目瞭然です。</p>
	<!-- /wp:paragraph -->
	...
	<div class="wp-block-columns is-not-stacked-on-mobile" style="gap:var(--wp--preset--spacing--30)">
		...
		<div class="wp-block-column" style="border-radius:8px;border:2px solid var(--wp--preset--color--secondary);padding:var(--wp--preset--spacing--40);background-color:#fafafa">
			...
			<p class="has-text-align-center" style="font-weight:700;font-size:var(--wp--preset--font-size--large);color:#888888;margin-bottom:var(--wp--preset--spacing--30)">従来の運用</p>
			<!-- /wp:paragraph -->
			...
			<div class="wp-block-group" style="gap:var(--wp--preset--spacing--20)">
				...
				<p style="font-size:var(--wp--preset--font-size--medium);line-height:1.6;color:#555555">✕ &nbsp;ライターへの発注・管理コストが高い</p>
				<!-- /wp:paragraph -->
				<!-- wp:paragraph {"style":{"typography":{"fontSize":"var(--wp--preset--font-size--medium)","lineHeight":"1.6"},"color":{"text":"#555555"}}} -->
				<p style="font-size:var(--wp--preset--font-size--medium);line-height:1.6;color:#555555">✕ &nbsp;更新頻度が担当者のリソースに依存</p>
				<!-- /wp:paragraph -->
				<!-- wp:paragraph {"style":{"typography":{"fontSize":"var(--wp--preset--font-size--medium)","lineHeight":"1.6"},"color":{"text":"#555555"}}} -->
				<p style="font-size:var(--wp--preset--font-size--medium);line-height:1.6;color:#555555">✕ &nbsp;SEO 施策が属人的で継続しにくい</p>
				<!-- /wp:paragraph -->
				<!-- wp:paragraph {"style":{"typography":{"fontSize":"var(--wp--preset--font-size--medium)","lineHeight":"1.6"},"color":{"text":"#555555"}}} -->
				<p style="font-size:var(--wp--preset--font-size--medium);line-height:1.6;color:#555555">✕ &nbsp;複数ツールで成果の把握に時間がかかる</p>
				<!-- /wp:paragraph -->
				<!-- wp:paragraph {"style":{"typography":{"fontSize":"var(--wp--preset--font-size--medium)","lineHeight":"1.6"},"color":{"text":"#555555"}}} -->
				<p style="font-size:var(--wp--preset--font-size--medium);line-height:1.6;color:#555555">✕ &nbsp;担当者交代のたびにノウハウが失われる</p>
				<!-- /wp:paragraph -->
		...
		<div class="wp-block-column" style="border-radius:8px;border:2px solid var(--wp--preset--color--accent);padding:var(--wp--preset--spacing--40);background-color:#ffffff">
			...
			<div class="wp-block-group" style="gap:var(--wp--preset--spacing--20)">
				...
				<p style="font-size:var(--wp--preset--font-size--medium);font-weight:500;line-height:1.6;color:#222222">◎ &nbsp;AI がコンテンツを自動生成・管理</p>
				<!-- /wp:paragraph -->
				<!-- wp:paragraph {"style":{"typography":{"fontSize":"var(--wp--preset--font-size--medium)","fontWeight":"500","lineHeight":"1.6"},"color":{"text":"#222222"}}} -->
				<p style="font-size:var(--wp--preset--font-size--medium);font-weight:500;line-height:1.6;color:#222222">◎ &nbsp;24時間・365日、自律的に更新</p>
				<!-- /wp:paragraph -->
				<!-- wp:paragraph {"style":{"typography":{"fontSize":"var(--wp--preset--font-size--medium)","fontWeight":"500","lineHeight":"1.6"},"color":{"text":"#222222"}}} -->
				<p style="font-size:var(--wp--preset--font-size--medium);font-weight:500;line-height:1.6;color:#222222">◎ &nbsp;SEO 最適化がシステムで一貫維持</p>
				<!-- /wp:paragraph -->
				<!-- wp:paragraph {"style":{"typography":{"fontSize":"var(--wp--preset--font-size--medium)","fontWeight":"500","lineHeight":"1.6"},"color":{"text":"#222222"}}} -->
				<p style="font-size:var(--wp--preset--font-size--medium);font-weight:500;line-height:1.6;color:#222222">◎ &nbsp;ひとつの画面で全成果をリアルタイム確認</p>
				<!-- /wp:paragraph -->
				<!-- wp:paragraph {"style":{"typography":{"fontSize":"var(--wp--preset--font-size--medium)","fontWeight":"500","lineHeight":"1.6"},"color":{"text":"#222222"}}} -->
				<p style="font-size:var(--wp--preset--font-size--medium);font-weight:500;line-height:1.6;color:#222222">◎ &nbsp;組織の知見がシステムに蓄積される</p>
				<!-- /wp:paragraph -->
