...
<div class="wp-block-group alignfull an-section an-section--features4" style="padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--40)">
	...
	<div class="wp-block-columns alignwide an-features4" style="border-top:1px solid var(--wp--preset--color--primary)">
	<?php foreach ( $an_items as $i => $it ) : ?>
		...
		<div class="wp-block-column" style="<?php echo $i > 0 ? 'border-left:1px solid var(--wp--preset--color--secondary);' : ''; ?>padding-top:var(--wp--preset--spacing--30);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30);padding-left:var(--wp--preset--spacing--30)">
