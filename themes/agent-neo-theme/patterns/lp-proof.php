...
<div class="wp-block-group alignfull an-lp-proof has-background-background-color has-background" style="padding-top:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--40)">
	...
	<div class="wp-block-columns is-not-stacked-on-mobile" style="gap:var(--wp--preset--spacing--20)">
		...
		<div class="wp-block-column" style="border-radius:8px;border-top:1px solid var(--wp--preset--color--secondary);border-left:1px solid var(--wp--preset--color--secondary);border-right:1px solid var(--wp--preset--color--secondary);border-bottom:3px solid var(--wp--preset--color--accent);padding:var(--wp--preset--spacing--40) var(--wp--preset--spacing--30);background-color:#ffffff;display:flex;flex-direction:column;align-items:center">
			...
			<!-- /wp:paragraph -->
			<!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"var(--wp--preset--font-size--small)"},"color":{"text":"#6b6b6b"}}} -->
			<p class="has-text-align-center" style="font-size:var(--wp--preset--font-size--small);color:#6b6b6b"><?php esc_html_e( '平均品質スコア 87点', 'agent-neo' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column" style="border-radius:8px;border-top:1px solid var(--wp--preset--color--secondary);border-left:1px solid var(--wp--preset--color--secondary);border-right:1px solid var(--wp--preset--color--secondary);border-bottom:3px solid var(--wp--preset--color--accent);padding:var(--wp--preset--spacing--40) var(--wp--preset--spacing--30);background-color:#ffffff;display:flex;flex-direction:column;align-items:center">
			...
			<!-- /wp:paragraph -->
			<!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"var(--wp--preset--font-size--small)"},"color":{"text":"#6b6b6b"}}} -->
			<p class="has-text-align-center" style="font-size:var(--wp--preset--font-size--small);color:#6b6b6b"><?php esc_html_e( '導入後6ヶ月比較', 'agent-neo' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column" style="border-radius:8px;border-top:1px solid var(--wp--preset--color--secondary);border-left:1px solid var(--wp--preset--color--secondary);border-right:1px solid var(--wp--preset--color--secondary);border-bottom:3px solid var(--wp--preset--color--accent);padding:var(--wp--preset--spacing--40) var(--wp--preset--spacing--30);background-color:#ffffff;display:flex;flex-direction:column;align-items:center">
			...
			<!-- /wp:paragraph -->
			<!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"var(--wp--preset--font-size--small)"},"color":{"text":"#6b6b6b"}}} -->
			<p class="has-text-align-center" style="font-size:var(--wp--preset--font-size--small);color:#6b6b6b"><?php esc_html_e( '月間担当者作業時間の比較', 'agent-neo' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column" style="border-radius:8px;border-top:1px solid var(--wp--preset--color--secondary);border-left:1px solid var(--wp--preset--color--secondary);border-right:1px solid var(--wp--preset--color--secondary);border-bottom:3px solid var(--wp--preset--color--accent);padding:var(--wp--preset--spacing--40) var(--wp--preset--spacing--30);background-color:#ffffff;display:flex;flex-direction:column;align-items:center">
			...
			<!-- /wp:paragraph -->
			<!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"var(--wp--preset--font-size--small)"},"color":{"text":"#6b6b6b"}}} -->
			<p class="has-text-align-center" style="font-size:var(--wp--preset--font-size--small);color:#6b6b6b"><?php esc_html_e( '継続率 96%', 'agent-neo' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
