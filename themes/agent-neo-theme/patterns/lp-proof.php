...
<div class="wp-block-group alignfull an-lp-proof has-background-background-color has-background" style="padding-top:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--40)">
	...
	<div class="wp-block-columns is-not-stacked-on-mobile" style="gap:var(--wp--preset--spacing--20)">
		...
		<div class="wp-block-column" style="border-radius:8px;border-top:1px solid var(--wp--preset--color--secondary);border-left:1px solid var(--wp--preset--color--secondary);border-right:1px solid var(--wp--preset--color--secondary);border-bottom:3px solid var(--wp--preset--color--accent);padding:var(--wp--preset--spacing--40) var(--wp--preset--spacing--30);background-color:var(--wp--preset--color--background);display:flex;flex-direction:column;align-items:center">
			<!-- wp:paragraph {"align":"center","style":{"typography":{"fontWeight":"800","lineHeight":"1.0"},"color":{"text":"var(--wp--preset--color--accent-aa)"},"spacing":{"margin":{"bottom":"var:preset|spacing|10"}}}} -->
			<p class="has-text-align-center" style="font-weight:800;font-size:3.5rem;line-height:1.0;color:var(--wp--preset--color--accent-aa);margin-bottom:var(--wp--preset--spacing--10)">2,400<span style="font-size:1.5rem"><?php esc_html_e( '件', 'agent-neo' ); ?></span></p>
			<!-- /wp:paragraph -->
			...
			<p class="has-text-align-center" style="font-size:var(--wp--preset--font-size--small);color:var(--wp--preset--color--muted)"><?php esc_html_e( '平均品質スコア 87点', 'agent-neo' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column" style="border-radius:8px;border-top:1px solid var(--wp--preset--color--secondary);border-left:1px solid var(--wp--preset--color--secondary);border-right:1px solid var(--wp--preset--color--secondary);border-bottom:3px solid var(--wp--preset--color--accent);padding:var(--wp--preset--spacing--40) var(--wp--preset--spacing--30);background-color:var(--wp--preset--color--background);display:flex;flex-direction:column;align-items:center">
			<!-- wp:paragraph {"align":"center","style":{"typography":{"fontWeight":"800","lineHeight":"1.0"},"color":{"text":"var(--wp--preset--color--accent-aa)"},"spacing":{"margin":{"bottom":"var:preset|spacing|10"}}}} -->
			<p class="has-text-align-center" style="font-weight:800;font-size:3.5rem;line-height:1.0;color:var(--wp--preset--color--accent-aa);margin-bottom:var(--wp--preset--spacing--10)">+340<span style="font-size:1.5rem">%</span></p>
			<!-- /wp:paragraph -->
			<!-- wp:paragraph {"align":"center","style":{"typography":{"fontWeight":"700","fontSize":"var(--wp--preset--font-size--medium)"},"color":{"text":"var(--wp--preset--color--primary)"},"spacing":{"margin":{"bottom":"var:preset|spacing|10"}}}} -->
			...
			<!-- /wp:paragraph -->
			<!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"var(--wp--preset--font-size--small)"},"color":{"text":"var(--wp--preset--color--muted)"}}} -->
			<p class="has-text-align-center" style="font-size:var(--wp--preset--font-size--small);color:var(--wp--preset--color--muted)"><?php esc_html_e( '導入後6ヶ月比較', 'agent-neo' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column" style="border-radius:8px;border-top:1px solid var(--wp--preset--color--secondary);border-left:1px solid var(--wp--preset--color--secondary);border-right:1px solid var(--wp--preset--color--secondary);border-bottom:3px solid var(--wp--preset--color--accent);padding:var(--wp--preset--spacing--40) var(--wp--preset--spacing--30);background-color:var(--wp--preset--color--background);display:flex;flex-direction:column;align-items:center">
			<!-- wp:paragraph {"align":"center","style":{"typography":{"fontWeight":"800","lineHeight":"1.0"},"color":{"text":"var(--wp--preset--color--accent-aa)"},"spacing":{"margin":{"bottom":"var:preset|spacing|10"}}}} -->
			<p class="has-text-align-center" style="font-weight:800;font-size:3.5rem;line-height:1.0;color:var(--wp--preset--color--accent-aa);margin-bottom:var(--wp--preset--spacing--10)">80<span style="font-size:1.5rem">%</span></p>
			<!-- /wp:paragraph -->
			<!-- wp:paragraph {"align":"center","style":{"typography":{"fontWeight":"700","fontSize":"var(--wp--preset--font-size--medium)"},"color":{"text":"var(--wp--preset--color--primary)"},"spacing":{"margin":{"bottom":"var:preset|spacing|10"}}}} -->
			...
			<!-- /wp:paragraph -->
			<!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"var(--wp--preset--font-size--small)"},"color":{"text":"var(--wp--preset--color--muted)"}}} -->
			<p class="has-text-align-center" style="font-size:var(--wp--preset--font-size--small);color:var(--wp--preset--color--muted)"><?php esc_html_e( '月間担当者作業時間の比較', 'agent-neo' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column" style="border-radius:8px;border-top:1px solid var(--wp--preset--color--secondary);border-left:1px solid var(--wp--preset--color--secondary);border-right:1px solid var(--wp--preset--color--secondary);border-bottom:3px solid var(--wp--preset--color--accent);padding:var(--wp--preset--spacing--40) var(--wp--preset--spacing--30);background-color:var(--wp--preset--color--background);display:flex;flex-direction:column;align-items:center">
			<!-- wp:paragraph {"align":"center","style":{"typography":{"fontWeight":"800","lineHeight":"1.0"},"color":{"text":"var(--wp--preset--color--accent-aa)"},"spacing":{"margin":{"bottom":"var:preset|spacing|10"}}}} -->
			<p class="has-text-align-center" style="font-weight:800;font-size:3.5rem;line-height:1.0;color:var(--wp--preset--color--accent-aa);margin-bottom:var(--wp--preset--spacing--10)">150<span style="font-size:1.5rem"><?php esc_html_e( '社', 'agent-neo' ); ?></span></p>
			<!-- /wp:paragraph -->
			<!-- wp:paragraph {"align":"center","style":{"typography":{"fontWeight":"700","fontSize":"var(--wp--preset--font-size--medium)"},"color":{"text":"var(--wp--preset--color--primary)"},"spacing":{"margin":{"bottom":"var:preset|spacing|10"}}}} -->
			...
			<!-- /wp:paragraph -->
			<!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"var(--wp--preset--font-size--small)"},"color":{"text":"var(--wp--preset--color--muted)"}}} -->
			<p class="has-text-align-center" style="font-size:var(--wp--preset--font-size--small);color:var(--wp--preset--color--muted)"><?php esc_html_e( '継続率 96%', 'agent-neo' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
