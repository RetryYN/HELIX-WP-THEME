...
<div class="wp-block-group alignfull an-lp-use-case has-secondary-background-color has-background" style="padding-top:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--40)">
	...
	<h2 class="wp-block-heading has-text-align-center" style="font-weight:700;margin-bottom:var(--wp--preset--spacing--20)">こんな現場で使われています</h2>
	<!-- /wp:heading -->
	...
	<p class="has-text-align-center" style="font-size:var(--wp--preset--font-size--medium);margin-bottom:var(--wp--preset--spacing--50);color:#555555">業種・規模を問わず、WordPress を運用するあらゆる組織で導入が進んでいます。</p>
	<!-- /wp:paragraph -->
	...
	<div class="wp-block-columns is-not-stacked-on-mobile" style="gap:var(--wp--preset--spacing--30)">
		...
		<div class="wp-block-column" style="border-radius:8px;border:1px solid var(--wp--preset--color--background);padding:var(--wp--preset--spacing--40);background-color:#ffffff">
			...
			<p style="font-weight:700;font-size:var(--wp--preset--font-size--large);color:var(--wp--preset--color--accent);margin-bottom:var(--wp--preset--spacing--20)">EC・通販サイト</p>
			<!-- /wp:paragraph -->
			...
			<div class="wp-block-group" style="border-radius:6px;padding:var(--wp--preset--spacing--20) var(--wp--preset--spacing--30);background-color:#fff3e6;margin-bottom:var(--wp--preset--spacing--20)">
				...
				<p style="font-size:var(--wp--preset--font-size--medium);line-height:1.7;color:#555555">商品レビュー・使い方コラムをライターに外注。月4〜5本が限界で、商品数に対してコンテンツが追いついていなかった。</p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
			...
			<div class="wp-block-group" style="border-radius:6px;border-left:3px solid var(--wp--preset--color--accent);padding:var(--wp--preset--spacing--20) var(--wp--preset--spacing--30);background-color:#ffffff">
				...
				<p style="font-size:var(--wp--preset--font-size--medium);line-height:1.7;color:#333333">月60本以上の商品コンテンツを自動生成・公開。オーガニック流入が6ヶ月で2.4倍に増加し、広告費を30%削減。</p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
		...
		<div class="wp-block-column" style="border-radius:8px;border:1px solid var(--wp--preset--color--background);padding:var(--wp--preset--spacing--40);background-color:#ffffff">
			...
			<!-- wp:paragraph {"style":{"typography":{"fontWeight":"700","fontSize":"var(--wp--preset--font-size--large)"},"color":{"text":"var(--wp--preset--color--accent)"},"spacing":{"margin":{"bottom":"var:preset|spacing|20"}}}} -->
			<p style="font-weight:700;font-size:var(--wp--preset--font-size--large);color:var(--wp--preset--color--accent);margin-bottom:var(--wp--preset--spacing--20)">専門メディア・情報サイト</p>
			<!-- /wp:paragraph -->
			...
			<div class="wp-block-group" style="border-radius:6px;padding:var(--wp--preset--spacing--20) var(--wp--preset--spacing--30);background-color:#fff3e6;margin-bottom:var(--wp--preset--spacing--20)">
				...
				<!-- /wp:paragraph -->
				<!-- wp:paragraph {"style":{"typography":{"fontSize":"var(--wp--preset--font-size--medium)","lineHeight":"1.7"},"color":{"text":"#555555"}}} -->
				<p style="font-size:var(--wp--preset--font-size--medium);line-height:1.7;color:#555555">編集部2名が記事制作を担当。更新が週2〜3本に限られ、競合メディアに検索順位を奪われ続けていた。</p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
			...
			<div class="wp-block-group" style="border-radius:6px;border-left:3px solid var(--wp--preset--color--accent);padding:var(--wp--preset--spacing--20) var(--wp--preset--spacing--30);background-color:#ffffff">
				...
				<!-- /wp:paragraph -->
				<!-- wp:paragraph {"style":{"typography":{"fontSize":"var(--wp--preset--font-size--medium)","lineHeight":"1.7"},"color":{"text":"#333333"}}} -->
				<p style="font-size:var(--wp--preset--font-size--medium);line-height:1.7;color:#333333">同じ体制で週20本超の更新を実現。編集部は企画・監修に集中でき、総PVが4ヶ月で1.8倍に回復。</p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
		...
		<div class="wp-block-column" style="border-radius:8px;border:1px solid var(--wp--preset--color--background);padding:var(--wp--preset--spacing--40);background-color:#ffffff">
			...
			<!-- wp:paragraph {"style":{"typography":{"fontWeight":"700","fontSize":"var(--wp--preset--font-size--large)"},"color":{"text":"var(--wp--preset--color--accent)"},"spacing":{"margin":{"bottom":"var:preset|spacing|20"}}}} -->
			<p style="font-weight:700;font-size:var(--wp--preset--font-size--large);color:var(--wp--preset--color--accent);margin-bottom:var(--wp--preset--spacing--20)">BtoB SaaS・コーポレートサイト</p>
			<!-- /wp:paragraph -->
			...
			<div class="wp-block-group" style="border-radius:6px;padding:var(--wp--preset--spacing--20) var(--wp--preset--spacing--30);background-color:#fff3e6;margin-bottom:var(--wp--preset--spacing--20)">
				...
				<!-- /wp:paragraph -->
				<!-- wp:paragraph {"style":{"typography":{"fontSize":"var(--wp--preset--font-size--medium)","lineHeight":"1.7"},"color":{"text":"#555555"}}} -->
				<p style="font-size:var(--wp--preset--font-size--medium);line-height:1.7;color:#555555">マーケ担当1名が兼任でブログを運営。月1〜2本しか公開できず、SEOによるリード獲得がほぼ機能していなかった。</p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
			...
			<div class="wp-block-group" style="border-radius:6px;border-left:3px solid var(--wp--preset--color--accent);padding:var(--wp--preset--spacing--20) var(--wp--preset--spacing--30);background-color:#ffffff">
				...
				<!-- /wp:paragraph -->
				<!-- wp:paragraph {"style":{"typography":{"fontSize":"var(--wp--preset--font-size--medium)","lineHeight":"1.7"},"color":{"text":"#333333"}}} -->
				<p style="font-size:var(--wp--preset--font-size--medium);line-height:1.7;color:#333333">月15本のコラム公開を自動化。担当者は戦略立案に集中でき、問い合わせ経路のSEO比率が8ヶ月で12%→38%に上昇。</p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
