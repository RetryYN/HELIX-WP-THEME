...
<aside class="wp-block-group an-article-box an-article-box--notice has-secondary-background-color has-background" style="border-left-color:var(--wp--preset--color--accent-aa);border-left-style:solid;border-left-width:1px;margin-top:var(--wp--preset--spacing--40);margin-bottom:var(--wp--preset--spacing--40);padding-top:var(--wp--preset--spacing--30);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30);padding-left:var(--wp--preset--spacing--30)"><!-- wp:heading {"level":3,"textColor":"accent-aa","style":{"typography":{"fontWeight":"700"}},"fontSize":"medium"} -->
