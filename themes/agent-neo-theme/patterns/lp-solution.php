	...
	<div class="wp-block-columns is-not-stacked-on-mobile are-vertically-aligned-center" style="gap:var(--wp--preset--spacing--50)">
		...
		<div class="wp-block-column is-vertically-aligned-center">
			...
			<div class="wp-block-group" style="margin-bottom:var(--wp--preset--spacing--40);gap:var(--wp--preset--spacing--10)">
				...
				<p style="font-size:var(--wp--preset--font-size--medium);line-height:1.7;color:var(--wp--preset--color--foreground)"><?php esc_html_e( 'キーワード選定から構成案・本文・タイトル・メタ説明まで AI が一貫して生成。編集者はレビューと承認のみに集中できます。', 'agent-neo' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
			...
			<div class="wp-block-group" style="margin-bottom:var(--wp--preset--spacing--40);gap:var(--wp--preset--spacing--10)">
				...
				<!-- /wp:paragraph -->
				<!-- wp:paragraph {"style":{"typography":{"fontSize":"var(--wp--preset--font-size--medium)","lineHeight":"1.7"},"color":{"text":"var(--wp--preset--color--foreground)"}}} -->
				<p style="font-size:var(--wp--preset--font-size--medium);line-height:1.7;color:var(--wp--preset--color--foreground)"><?php esc_html_e( '検索順位・クリック率を継続監視し、タイトル改善・内部リンク最適化・古い記事のリライトを自動スケジュールします。', 'agent-neo' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
			...
			<div class="wp-block-group" style="gap:var(--wp--preset--spacing--10)">
				...
				<!-- /wp:paragraph -->
				<!-- wp:paragraph {"style":{"typography":{"fontSize":"var(--wp--preset--font-size--medium)","lineHeight":"1.7"},"color":{"text":"var(--wp--preset--color--foreground)"}}} -->
				<p style="font-size:var(--wp--preset--font-size--medium);line-height:1.7;color:var(--wp--preset--color--foreground)"><?php esc_html_e( 'PV・順位・CV・生成ステータスをひとつの画面で把握。施策の効果を即座に判断し、戦略に反映できます。', 'agent-neo' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
