...
<div class="wp-block-group alignfull an-lp-pricing has-background-background-color has-background" style="padding-top:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--40)">
	...
	<p class="has-text-align-center" style="font-size:var(--wp--preset--font-size--medium);margin-bottom:var(--wp--preset--spacing--50);color:#555555"><?php esc_html_e( 'すべてのプランで14日間の無料トライアルが利用できます。クレジットカード登録は不要です。', 'agent-neo' ); ?></p>
	<!-- /wp:paragraph -->
	...
	<div class="wp-block-columns is-not-stacked-on-mobile are-vertically-aligned-top" style="gap:var(--wp--preset--spacing--30)">
		...
		<div class="wp-block-column is-vertically-aligned-top" style="border-radius:8px;border:2px solid var(--wp--preset--color--secondary);padding:var(--wp--preset--spacing--40);background-color:#fafafa">
			...
			<div class="wp-block-group" style="gap:var(--wp--preset--spacing--20);margin-bottom:var(--wp--preset--spacing--40)">
				...
				<p style="font-size:var(--wp--preset--font-size--medium);line-height:1.5;color:#333333">✓ &nbsp;<?php esc_html_e( 'AI 記事生成：月20本まで', 'agent-neo' ); ?></p>
				<!-- /wp:paragraph -->
				<!-- wp:paragraph {"style":{"typography":{"fontSize":"var(--wp--preset--font-size--medium)","lineHeight":"1.5"},"color":{"text":"#333333"}}} -->
				<p style="font-size:var(--wp--preset--font-size--medium);line-height:1.5;color:#333333">✓ &nbsp;<?php esc_html_e( '1 WordPressサイト接続', 'agent-neo' ); ?></p>
				<!-- /wp:paragraph -->
				<!-- wp:paragraph {"style":{"typography":{"fontSize":"var(--wp--preset--font-size--medium)","lineHeight":"1.5"},"color":{"text":"#333333"}}} -->
				<p style="font-size:var(--wp--preset--font-size--medium);line-height:1.5;color:#333333">✓ &nbsp;<?php esc_html_e( '基本 SEO 最適化', 'agent-neo' ); ?></p>
				<!-- /wp:paragraph -->
				<!-- wp:paragraph {"style":{"typography":{"fontSize":"var(--wp--preset--font-size--medium)","lineHeight":"1.5"},"color":{"text":"#333333"}}} -->
		...
		<div class="wp-block-column is-vertically-aligned-top" style="border-radius:8px;border:2px solid var(--wp--preset--color--accent);padding:var(--wp--preset--spacing--40);background-color:#ffffff">
			...
			<div class="wp-block-group" style="gap:var(--wp--preset--spacing--20);margin-bottom:var(--wp--preset--spacing--40)">
				...
				<p style="font-weight:600;font-size:var(--wp--preset--font-size--medium);line-height:1.5;color:#333333">✓ &nbsp;<?php esc_html_e( 'AI 記事生成：月100本まで', 'agent-neo' ); ?></p>
				<!-- /wp:paragraph -->
				<!-- wp:paragraph {"style":{"typography":{"fontWeight":"600","fontSize":"var(--wp--preset--font-size--medium)","lineHeight":"1.5"},"color":{"text":"#333333"}}} -->
				<p style="font-weight:600;font-size:var(--wp--preset--font-size--medium);line-height:1.5;color:#333333">✓ &nbsp;<?php esc_html_e( '5 WordPressサイト接続', 'agent-neo' ); ?></p>
				<!-- /wp:paragraph -->
				<!-- wp:paragraph {"style":{"typography":{"fontWeight":"600","fontSize":"var(--wp--preset--font-size--medium)","lineHeight":"1.5"},"color":{"text":"#333333"}}} -->
				<p style="font-weight:600;font-size:var(--wp--preset--font-size--medium);line-height:1.5;color:#333333">✓ &nbsp;<?php esc_html_e( '高度 SEO 最適化 + A/B テスト', 'agent-neo' ); ?></p>
				<!-- /wp:paragraph -->
				<!-- wp:paragraph {"style":{"typography":{"fontWeight":"600","fontSize":"var(--wp--preset--font-size--medium)","lineHeight":"1.5"},"color":{"text":"#333333"}}} -->
				<p style="font-weight:600;font-size:var(--wp--preset--font-size--medium);line-height:1.5;color:#333333">✓ &nbsp;<?php esc_html_e( '詳細分析ダッシュボード', 'agent-neo' ); ?></p>
				<!-- /wp:paragraph -->
				<!-- wp:paragraph {"style":{"typography":{"fontWeight":"600","fontSize":"var(--wp--preset--font-size--medium)","lineHeight":"1.5"},"color":{"text":"#333333"}}} -->
		...
		<div class="wp-block-column is-vertically-aligned-top" style="border-radius:8px;border:2px solid var(--wp--preset--color--secondary);padding:var(--wp--preset--spacing--40);background-color:#fafafa">
			...
			<div class="wp-block-group" style="gap:var(--wp--preset--spacing--20);margin-bottom:var(--wp--preset--spacing--40)">
				<!-- wp:paragraph {"style":{"typography":{"fontSize":"var(--wp--preset--font-size--medium)","lineHeight":"1.5"},"color":{"text":"#333333"}}} -->
				<p style="font-size:var(--wp--preset--font-size--medium);line-height:1.5;color:#333333">✓ &nbsp;<?php esc_html_e( 'AI 記事生成：無制限', 'agent-neo' ); ?></p>
				<!-- /wp:paragraph -->
				<!-- wp:paragraph {"style":{"typography":{"fontSize":"var(--wp--preset--font-size--medium)","lineHeight":"1.5"},"color":{"text":"#333333"}}} -->
				<p style="font-size:var(--wp--preset--font-size--medium);line-height:1.5;color:#333333">✓ &nbsp;<?php esc_html_e( '無制限サイト接続', 'agent-neo' ); ?></p>
				<!-- /wp:paragraph -->
				<!-- wp:paragraph {"style":{"typography":{"fontSize":"var(--wp--preset--font-size--medium)","lineHeight":"1.5"},"color":{"text":"#333333"}}} -->
				<p style="font-size:var(--wp--preset--font-size--medium);line-height:1.5;color:#333333">✓ &nbsp;<?php esc_html_e( 'カスタム SEO 戦略設定', 'agent-neo' ); ?></p>
				<!-- /wp:paragraph -->
				<!-- wp:paragraph {"style":{"typography":{"fontSize":"var(--wp--preset--font-size--medium)","lineHeight":"1.5"},"color":{"text":"#333333"}}} -->
				<p style="font-size:var(--wp--preset--font-size--medium);line-height:1.5;color:#333333">✓ &nbsp;<?php esc_html_e( 'BI 連携・カスタムレポート', 'agent-neo' ); ?></p>
				<!-- /wp:paragraph -->
				<!-- wp:paragraph {"style":{"typography":{"fontSize":"var(--wp--preset--font-size--medium)","lineHeight":"1.5"},"color":{"text":"#333333"}}} -->
				<p style="font-size:var(--wp--preset--font-size--medium);line-height:1.5;color:#333333">✓ &nbsp;<?php esc_html_e( 'マルチサイト一元管理', 'agent-neo' ); ?></p>
				<!-- /wp:paragraph -->
				<!-- wp:paragraph {"style":{"typography":{"fontSize":"var(--wp--preset--font-size--medium)","lineHeight":"1.5"},"color":{"text":"#333333"}}} -->
				<p style="font-size:var(--wp--preset--font-size--medium);line-height:1.5;color:#333333">✓ &nbsp;<?php esc_html_e( '専任カスタマーサクセス', 'agent-neo' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
