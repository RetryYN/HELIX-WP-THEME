...
<!-- wp:site-title {"level":0,"textColor":"background","style":{"typography":{"fontWeight":"800"}},"fontSize":"xxx-large"} /-->
...
<!-- wp:navigation {"textColor":"background","overlayMenu":"never","style":{"spacing":{"blockGap":"var:preset|spacing|30"}},"fontSize":"small","layout":{"type":"flex","justifyContent":"right","flexWrap":"wrap"},"ariaLabel":"<?php echo esc_attr__( 'フッターナビゲーション', 'agent-neo' ); ?>"} -->
