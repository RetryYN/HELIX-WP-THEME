...
<!-- wp:site-title {"level":0,"style":{"typography":{"fontWeight":"800"}},"textColor":"foreground","fontSize":"large"} /-->
...
<!-- wp:navigation {"textColor":"muted","overlayMenu":"never","style":{"spacing":{"blockGap":"var:preset|spacing|30"}},"fontSize":"small","layout":{"type":"flex","justifyContent":"left","flexWrap":"wrap"},"ariaLabel":"カテゴリー"} -->
