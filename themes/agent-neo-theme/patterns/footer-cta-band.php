...
<!-- wp:group {"className":"an-footer-cta-band","style":{"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50","left":"var:preset|spacing|40","right":"var:preset|spacing|40"},"blockGap":"var:preset|spacing|30"}},"backgroundColor":"accent-aa","textColor":"background","layout":{"type":"constrained"}} -->
...
<!-- wp:heading {"style":{"typography":{"fontWeight":"800","lineHeight":"1.2","textAlign":"center"}},"textColor":"background","fontSize":"xx-large"} -->
...
<div class="wp-block-group" style="border-top-color:var(--wp--preset--color--muted);border-top-style:solid;border-top-width:1px;padding-top:var(--wp--preset--spacing--30)">
