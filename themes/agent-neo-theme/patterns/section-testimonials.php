...
<div class="wp-block-column"><!-- wp:quote {"className":"an-testimonial-card","style":{"border":{"left":{"color":"var(u002du002dwpu002du002dpresetu002du002dcoloru002du002daccent-aa)","width":"1px","style":"solid"}},"spacing":{"padding":{"left":"var:preset|spacing|30","top":"var:preset|spacing|20","bottom":"var:preset|spacing|20"}}},"backgroundColor":"background"} -->
<blockquote class="wp-block-quote an-testimonial-card has-background-background-color has-background" style="border-left-color:var(u002du002dwpu002du002dpresetu002du002dcoloru002du002daccent-aa);border-left-style:solid;border-left-width:1px;padding-top:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--30)"><p><?php esc_html_e( 'やることの順番が見え、会議の時間が短くなりました。', 'agent-neo' ); ?></p><cite><?php esc_html_e( '企画担当 A', 'agent-neo' ); ?></cite></blockquote>
<!-- /wp:quote --></div>
<!-- /wp:column -->

<!-- wp:column -->
<div class="wp-block-column"><!-- wp:quote {"className":"an-testimonial-card","style":{"border":{"left":{"color":"var(u002du002dwpu002du002dpresetu002du002dcoloru002du002daccent-aa)","width":"1px","style":"solid"}},"spacing":{"padding":{"left":"var:preset|spacing|30","top":"var:preset|spacing|20","bottom":"var:preset|spacing|20"}}},"backgroundColor":"background"} -->
<blockquote class="wp-block-quote an-testimonial-card has-background-background-color has-background" style="border-left-color:var(u002du002dwpu002du002dpresetu002du002dcoloru002du002daccent-aa);border-left-style:solid;border-left-width:1px;padding-top:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--30)"><p><?php esc_html_e( '文章の目的を揃えたことで、チームの判断が早くなりました。', 'agent-neo' ); ?></p><cite><?php esc_html_e( '編集担当 B', 'agent-neo' ); ?></cite></blockquote>
<!-- /wp:quote --></div>
<!-- /wp:column -->

<!-- wp:column -->
<div class="wp-block-column"><!-- wp:quote {"className":"an-testimonial-card","style":{"border":{"left":{"color":"var(u002du002dwpu002du002dpresetu002du002dcoloru002du002daccent-aa)","width":"1px","style":"solid"}},"spacing":{"padding":{"left":"var:preset|spacing|30","top":"var:preset|spacing|20","bottom":"var:preset|spacing|20"}}},"backgroundColor":"background"} -->
<blockquote class="wp-block-quote an-testimonial-card has-background-background-color has-background" style="border-left-color:var(u002du002dwpu002du002dpresetu002du002dcoloru002du002daccent-aa);border-left-style:solid;border-left-width:1px;padding-top:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--30)"><p><?php esc_html_e( '迷ったときに戻れる基準ができ、更新を続けやすくなりました。', 'agent-neo' ); ?></p><cite><?php esc_html_e( '運用担当 C', 'agent-neo' ); ?></cite></blockquote>
<!-- /wp:quote --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group --></div>
