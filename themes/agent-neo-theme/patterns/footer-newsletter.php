...
<!-- wp:group {"className":"an-footer-newsletter-band","style":{"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50","left":"var:preset|spacing|40","right":"var:preset|spacing|40"}}},"textColor":"background","gradient":"primary-to-footer","layout":{"type":"constrained"}} -->
...
<!-- wp:heading {"style":{"typography":{"fontWeight":"800","lineHeight":"1.2"}},"textColor":"background","fontSize":"x-large"} -->
...
<!-- wp:search {"label":"メールアドレス","showLabel":false,"placeholder":"you@example.com","buttonText":"登録する","buttonPosition":"button-inside","className":"an-newsletter-input","fontSize":"medium"} /-->
</div>
<!-- /wp:column -->
</div>
<!-- /wp:columns -->
...
<!-- wp:site-title {"level":0,"style":{"typography":{"fontWeight":"700"}},"textColor":"background","fontSize":"medium"} /-->
...
<div class="wp-block-group alignwide" style="border-top-color:var(--wp--preset--color--muted);border-top-style:solid;border-top-width:1px;padding-top:var(--wp--preset--spacing--20)">
