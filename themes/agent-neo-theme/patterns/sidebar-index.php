...
<div class="wp-block-group an-sidebar an-sidebar--index" style="border-left-color:var(--wp--preset--color--secondary);border-left-style:solid;border-left-width:1px;padding-left:var(--wp--preset--spacing--30)">
...
<!-- wp:heading {"style":{"typography":{"fontWeight":"700"}},"textColor":"muted","fontSize":"small"} -->
...
<!-- wp:categories {"showHierarchy":true,"showPostCounts":true,"className":"an-sidebar-categories","fontSize":"small"} /-->
</div>
<!-- /wp:group -->
...
<!-- wp:latest-posts {"postsToShow":6,"displayPostDate":true,"className":"an-sidebar-latest-plain","fontSize":"small"} /-->
</div>
<!-- /wp:group -->
...
<!-- wp:archives {"showPostCounts":true,"className":"an-sidebar-archives","fontSize":"small"} /-->
</div>
<!-- /wp:group -->
</div>
<!-- /wp:group -->
