...
<div id="faq" class="wp-block-group alignfull an-section an-section--faq" style="padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--40)"><!-- wp:group {"align":"wide","style":{"spacing":{"blockGap":"var:preset|spacing|20"}},"layout":{"type":"constrained"}} -->
...
<div class="wp-block-group alignwide" style="margin-top:var(--wp--preset--spacing--40)"><!-- wp:details {"className":"an-faq-item"} -->
<details class="wp-block-details an-faq-item"><summary><?php esc_html_e( 'どこから始めればよいですか？', 'agent-neo' ); ?></summary><!-- wp:paragraph {"textColor":"muted","fontSize":"small"} -->
...
<details class="wp-block-details an-faq-item"><summary><?php esc_html_e( '内容の変更はあとからできますか？', 'agent-neo' ); ?></summary><!-- wp:paragraph {"textColor":"muted","fontSize":"small"} -->
<p class="has-muted-color has-text-color has-small-font-size"><?php esc_html_e( '公開後もページの構成や文章は、運用状況に合わせて見直せます。', 'agent-neo' ); ?></p>
<!-- /wp:paragraph --></details>
<!-- /wp:details -->

<!-- wp:details {"className":"an-faq-item"} -->
<details class="wp-block-details an-faq-item"><summary><?php esc_html_e( '相談前に準備するものはありますか？', 'agent-neo' ); ?></summary><!-- wp:paragraph {"textColor":"muted","fontSize":"small"} -->
