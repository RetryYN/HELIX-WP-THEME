...
<div class="wp-block-group alignfull an-lp-benefit has-background-background-color has-background" style="padding-top:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--40)">
	...
	<p class="has-text-align-center" style="font-size:var(--wp--preset--font-size--medium);margin-bottom:var(--wp--preset--spacing--50);color:#555555"><?php esc_html_e( '他のツールでは実現できない、4つの核心価値をご紹介します。', 'agent-neo' ); ?></p>
	<!-- /wp:paragraph -->
	...
	<div class="wp-block-columns" style="gap:var(--wp--preset--spacing--30)">
		...
		<div class="wp-block-column" style="border-radius:8px;border:1px solid var(--wp--preset--color--secondary);padding:var(--wp--preset--spacing--40);background-color:#ffffff">
			...
			<p style="font-size:var(--wp--preset--font-size--medium);line-height:1.7;color:#444444"><?php esc_html_e( 'キーワード調査から公開・分析まで、担当者がいなくてもシステムが自律的に動き続けます。休日・深夜も止まりません。', 'agent-neo' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column" style="border-radius:8px;border:1px solid var(--wp--preset--color--secondary);padding:var(--wp--preset--spacing--40);background-color:#ffffff">
			...
			<!-- /wp:paragraph -->
			<!-- wp:paragraph {"style":{"typography":{"fontSize":"var(--wp--preset--font-size--medium)","lineHeight":"1.7"},"color":{"text":"#444444"}}} -->
			<p style="font-size:var(--wp--preset--font-size--medium);line-height:1.7;color:#444444"><?php esc_html_e( 'AI による品質チェックと自動修正で、ライターへの発注コストを抑えながら月100本超の更新を維持できます。', 'agent-neo' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column" style="border-radius:8px;border:1px solid var(--wp--preset--color--secondary);padding:var(--wp--preset--spacing--40);background-color:#ffffff">
			...
			<!-- /wp:paragraph -->
			<!-- wp:paragraph {"style":{"typography":{"fontSize":"var(--wp--preset--font-size--medium)","lineHeight":"1.7"},"color":{"text":"#444444"}}} -->
			<p style="font-size:var(--wp--preset--font-size--medium);line-height:1.7;color:#444444"><?php esc_html_e( 'プラグインをインストールするだけで連携完了。テーマやカスタマイズを変える必要はなく、既存サイト資産を活かせます。', 'agent-neo' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column" style="border-radius:8px;border:1px solid var(--wp--preset--color--secondary);padding:var(--wp--preset--spacing--40);background-color:#ffffff">
			...
			<!-- /wp:paragraph -->
			<!-- wp:paragraph {"style":{"typography":{"fontSize":"var(--wp--preset--font-size--medium)","lineHeight":"1.7"},"color":{"text":"#444444"}}} -->
			<p style="font-size:var(--wp--preset--font-size--medium);line-height:1.7;color:#444444"><?php esc_html_e( '順位変動・流入数・CV 率をリアルタイムで計測。どの施策が効いているかを可視化し、戦略の改善に直結させます。', 'agent-neo' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
