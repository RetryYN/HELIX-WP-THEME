...
<!-- wp:group {"align":"full","className":"an-section an-section--hero an-hero--gradient","gradient":"accent-to-primary","textColor":"background","style":{"spacing":{"padding":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|60","left":"var:preset|spacing|40","right":"var:preset|spacing|40"},"blockGap":"var:preset|spacing|30"}},"layout":{"type":"constrained","justifyContent":"left"}} -->
<div class="wp-block-group alignfull an-section an-section--hero an-hero--gradient has-background-color has-accent-to-primary-gradient-background has-text-color has-background" style="padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--40)">
	...
	<!-- wp:paragraph {"fontSize":"small","textColor":"background","style":{"typography":{"fontWeight":"700","textTransform":"uppercase"}}} -->
	...
	<!-- wp:buttons {"layout":{"type":"flex","justifyContent":"left"},"style":{"spacing":{"blockGap":"var:preset|spacing|20"}}} -->
