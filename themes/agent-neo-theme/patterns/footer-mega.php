...
<div class="wp-block-column" style="flex-basis:34%"><!-- wp:site-title {"level":0,"style":{"typography":{"fontWeight":"700"}},"textColor":"foreground","fontSize":"large"} /-->
...
<div class="wp-block-column an-footer-col" style="flex-basis:22%"><!-- wp:heading {"className":"an-footer-col-heading","style":{"typography":{"fontWeight":"700","textTransform":"uppercase"},"spacing":{"margin":{"bottom":"var:preset|spacing|20"}}},"textColor":"muted","fontSize":"small"} -->
...
<!-- wp:categories {"showPostCounts":true,"className":"an-footer-categories","fontSize":"small"} /--></div>
<!-- /wp:column -->
...
<!-- wp:latest-posts {"postsToShow":4,"displayPostDate":true,"className":"an-footer-latest","fontSize":"small"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->

<!-- wp:group {"align":"wide","style":{"border":{"top":{"color":"var(u002du002dwpu002du002dpresetu002du002dcoloru002du002dmuted)","width":"1px","style":"solid"}},"spacing":{"padding":{"top":"var:preset|spacing|30"},"blockGap":"var:preset|spacing|30"}},"layout":{"type":"flex","justifyContent":"space-between","flexWrap":"wrap"}} -->
<div class="wp-block-group alignwide" style="border-top-color:var(u002du002dwpu002du002dpresetu002du002dcoloru002du002dmuted);border-top-style:solid;border-top-width:1px;padding-top:var(--wp--preset--spacing--30)"><!-- wp:pattern {"slug":"agent-neo/footer-credit"} /-->
