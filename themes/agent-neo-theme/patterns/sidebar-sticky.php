...
<div class="wp-block-group an-sidebar-widget an-sidebar-toc" style="border-left-color:var(--wp--preset--color--secondary);border-left-style:solid;border-left-width:1px;padding-left:var(--wp--preset--spacing--20)">
<!-- wp:heading {"style":{"typography":{"fontWeight":"700","textTransform":"uppercase"}},"textColor":"muted","fontSize":"small"} -->
...
<!-- wp:button {"backgroundColor":"accent-aa","textColor":"background","className":"has-custom-width wp-block-button__width-100","style":{"typography":{"fontWeight":"700"}},"fontSize":"small"} -->
