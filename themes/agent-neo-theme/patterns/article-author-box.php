...
<div class="wp-block-group an-article-box an-article-box--author" style="border-top-color:var(--wp--preset--color--muted);border-top-style:solid;border-top-width:1px;margin-top:var(--wp--preset--spacing--50);padding-top:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--30)">
...
<!-- wp:avatar {"size":80,"style":{"border":{"radius":"var:preset|spacing|60"}}} /-->
</div>
<!-- /wp:column -->

<!-- wp:column {"verticalAlignment":"center","width":"82%"} -->
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:82%">
<!-- wp:post-author-name {"style":{"typography":{"fontWeight":"700"}},"fontSize":"large"} /-->
