...
<div class="wp-block-column" style="border-top-color:var(--wp--preset--color--accent);border-top-style:solid;border-top-width:1px;padding-top:var(--wp--preset--spacing--30)">
<!-- wp:paragraph {"textColor":"accent","style":{"typography":{"fontWeight":"800","lineHeight":"1"}},"fontSize":"xxx-large"} -->
