...
- authority owner: PO
- updated: 2026-09-24
- 最新整理: [`current-alignment.md`](current-alignment.md)（WT-EVT-0313、135候補 / 302 AC / 135 test ID。実装完了件数ではない）
...
| L3 | `docs/requirements/l3/requirements-ir.json`（全件ビュー `l3/g3-approval-summary.md`） | 135候補、302 AC。compile は backflow_required、G3 未実施。追加P1は暫定 | pending_resolution 3件、最新revisionの合意、直近2 iterationの優先度安定 → compile → specified → G3承認で frozen |
