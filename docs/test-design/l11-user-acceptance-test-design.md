...
| WT-UAT-05 | WT-UI-05 | サイト設定で選んだ主たる確認面（既定 SP）と PC の両幅で、共通 + device 別差分の面・語彙・目次・PR・構造化データ、A/B variant、画像、SNS share、CV・バナー・データ層イベントが崩れず出る | WT-Q-ZONE-01 / VOCAB-01〜04 / SEO-01 / SEO-06〜09 / AB-01 / IMG-01〜03 / SNS-01 / CV-01 / BANNER-01 / SP-01〜03 / TAG-01〜02 採否後 |
...
| WT-UAT-10 | WT-UI-10 | 管理画面だけで主たる確認面（既定 SP）、共通 + device 別差分、SP / PC 両幅プレビュー、A/B、画像、タグ slot・データ層・Consent Mode v2 写像・同意、第三者プラグインの領域別既定・警告、操作ログ、差分、rollback、鍵、CV、バナー、監査を扱え、AI が同じ値を読む | WT-Q-ADMIN-01 / 02 / AB-01 / IMG-01〜03 / CV-01 / BANNER-01 / AUDIT-01 / SP-01〜03 / TAG-01〜02 / PLUGIN-03 採否後 |
| WT-UAT-11 | WT-UI-11 | クローラー別の来訪指標、llms.txt / crawl-map のアクセス有無と効果実証用の時系列を確認し、robots.txt と AI クローラーの許可 / 拒否を同じ画面から設定できる | WT-Q-CRAWL-01 / SEO-08 採否後 |
