...
### 1g. サイドバー / フォーム / 抜け漏れの観察（`sidebar-forms-gap-survey/`、2026-09-06、PO 反応 21 回目 WT-EVT-0289〜0291）
...
- 限界（`summary.md` §4）: WebFetch 要約経由で追尾・SP・JS 要素は過小評価。トップの要約が挙げたフォーム URL が実在しないことがある（B 区分 5 件）。区分 n は小さい。
