...
$h2 = function ( $style, $id ) {
	echo '<!-- wp:group {"anchor":"' . $id . '","layout":{"type":"default"}} --><div class="wp-block-group" id="' . $id . '"><!-- wp:heading {"className":"is-style-wt-' . $style . '"} --><h2 class="wp-block-heading is-style-wt-' . $style . '">昇降デスクの選び方と 3 製品の比較</h2><!-- /wp:heading --><!-- wp:paragraph {"className":"wt-sub"} --><p class="wt-sub">補助文はミュートグレー。見出し本文は SP 390 で 20 字が 1 行に収まる。</p><!-- /wp:paragraph --></div><!-- /wp:group -->';
};
$h3 = function ( $style, $id ) {
	echo '<!-- wp:group {"anchor":"' . $id . '","layout":{"type":"default"}} --><div class="wp-block-group" id="' . $id . '"><!-- wp:heading {"level":3,"className":"is-style-wt-' . $style . '"} --><h3 class="wp-block-heading is-style-wt-' . $style . '">リフトワン L1：静かで低い位置まで下がる</h3><!-- /wp:heading --></div><!-- /wp:group -->';
};
?>
...
?>
<!-- wp:group {"anchor":"cat-box-check-list","layout":{"type":"default"}} --><div class="wp-block-group" id="cat-box-check-list"><!-- wp:group {"className":"is-style-wt-plain-border","layout":{"type":"default"}} --><div class="wp-block-group is-style-wt-plain-border"><!-- wp:list {"className":"is-style-wt-check"} --><ul class="wp-block-list is-style-wt-check"><li>3 製品の価格・昇降範囲・静音性の違い</li><li>部屋の広さと予算別のおすすめ</li><li>後悔しやすい 3 つの落とし穴</li></ul><!-- /wp:list --></div><!-- /wp:group --></div><!-- /wp:group -->
...
?>
<!-- wp:group {"className":"is-style-wt-steps","anchor":"cat-box-steps","layout":{"type":"default"}} --><div class="wp-block-group is-style-wt-steps" id="cat-box-steps"><!-- wp:paragraph --><p>無料登録して身長と机の高さを入力する</p><!-- /wp:paragraph --><!-- wp:paragraph --><p>2 週間、座り・立ちを交互に試す</p><!-- /wp:paragraph --><!-- wp:paragraph --><p>合わなければ 30 日以内に返品する</p><!-- /wp:paragraph --></div><!-- /wp:group -->
...
<!-- wp:group {"anchor":"cat-prosc","layout":{"type":"default"}} --><div class="wp-block-group" id="cat-prosc"><!-- wp:columns {"className":"wt-prosc"} --><div class="wp-block-columns wt-prosc"><!-- wp:column --><div class="wp-block-column"><!-- wp:group {"className":"is-style-wt-label-title wt-c-ok","layout":{"type":"default"}} --><div class="wp-block-group is-style-wt-label-title wt-c-ok"><!-- wp:paragraph --><p>メリット</p><!-- /wp:paragraph --><!-- wp:list {"className":"is-style-wt-pros"} --><ul class="wp-block-list is-style-wt-pros"><li>62cm まで下がる</li><li>昇降が静か</li><li>5 年保証</li></ul><!-- /wp:list --></div><!-- /wp:group --></div><!-- /wp:column --><!-- wp:column --><div class="wp-block-column"><!-- wp:group {"className":"is-style-wt-label-title wt-c-warn","layout":{"type":"default"}} --><div class="wp-block-group is-style-wt-label-title wt-c-warn"><!-- wp:paragraph --><p>デメリット</p><!-- /wp:paragraph --><!-- wp:list {"className":"is-style-wt-cons"} --><ul class="wp-block-list is-style-wt-cons"><li>天板は 2 サイズのみ</li><li>最高位置で少し揺れる</li></ul><!-- /wp:list --></div><!-- /wp:group --></div><!-- /wp:column --></div><!-- /wp:columns --></div><!-- /wp:group -->
<!-- wp:group {"anchor":"cat-rate","layout":{"type":"default"}} --><div class="wp-block-group" id="cat-rate"><!-- wp:html --><div class="wt-rate"><span>昇降範囲</span><i style="--v:94%"></i><b>4.7</b></div><div class="wt-rate"><span>静音性</span><i style="--v:90%"></i><b>4.5</b></div><div class="wt-rate"><span>価格・保証</span><i style="--v:84%"></i><b>4.2</b></div><!-- /wp:html --></div><!-- /wp:group -->
...
<!-- wp:group {"anchor":"cat-pr","layout":{"type":"default"}} --><div class="wp-block-group" id="cat-pr"><!-- wp:html --><p class="wt-pr is-style-wt-pr"><span class="wt-pr__tag">PR</span>本記事にはプロモーションが含まれます。</p><!-- /wp:html --></div><!-- /wp:group -->
<!-- wp:heading --><h2 class="wp-block-heading">de-text: 番号バッジ・アイコンリスト・引用符・数字</h2><!-- /wp:heading -->
<!-- wp:group {"anchor":"cat-detext","layout":{"type":"default"}} --><div class="wp-block-group" id="cat-detext"><!-- wp:list {"className":"is-style-wt-badge-list"} --><ol class="wp-block-list is-style-wt-badge-list"><li>無料登録して身長と机の高さを入力する</li><li>2 週間、座り・立ちを交互に試す</li><li>合わなければ 30 日以内に返品する</li></ol><!-- /wp:list --><!-- wp:list {"className":"is-style-wt-icon-list"} --><ul class="wp-block-list is-style-wt-icon-list"><li>迷ったら → リフトワン L1</li><li>予算優先 → スタンド・ライト S2</li></ul><!-- /wp:list --><!-- wp:quote {"className":"is-style-wt-quote-mark"} --><blockquote class="wp-block-quote is-style-wt-quote-mark"><p>「最初の 1 台としては十分でした」</p><cite>読者アンケートより（架空）</cite></blockquote><!-- /wp:quote --><!-- wp:paragraph {"align":"center"} --><p class="has-text-align-center"><span class="wt-num"><span class="wt-count" data-to="1284">1,284</span><small>件の実測</small></span></p><!-- /wp:paragraph --></div><!-- /wp:group -->
...
?>
<!-- wp:group {"anchor":"cat-prosc-contrast","className":"is-style-wt-pros-contrast","layout":{"type":"default"}} --><div class="wp-block-group is-style-wt-pros-contrast" id="cat-prosc-contrast"><!-- wp:html --><div class="wt-prosc__item wt-prosc__item--good"><p class="wt-prosc__title">メリット</p><ul><li>低い位置まで下がる</li><li>昇降音が控えめ</li><li>保証が長い</li></ul></div><div class="wt-prosc__item wt-prosc__item--bad"><p class="wt-prosc__title">デメリット</p><ul><li>天板の選択肢が少ない</li><li>上限位置で揺れが出る</li></ul></div><!-- /wp:html --></div><!-- /wp:group -->
<!-- wp:group {"anchor":"cat-prosc-icons","className":"is-style-wt-pros-icons","layout":{"type":"default"}} --><div class="wp-block-group is-style-wt-pros-icons" id="cat-prosc-icons"><!-- wp:html --><div class="wt-prosc__item wt-prosc__item--good"><p class="wt-prosc__title">○ メリット</p><ul class="wt-prosc__list"><li>座り姿勢に合わせやすい</li><li>操作が直感的</li><li>組み立て手順が短い</li></ul></div><div class="wt-prosc__item wt-prosc__item--bad"><p class="wt-prosc__title">× デメリット</p><ul class="wt-prosc__list"><li>設置幅を確認する必要がある</li><li>上位機より機能が少ない</li></ul></div><!-- /wp:html --></div><!-- /wp:group -->
<!-- wp:group {"anchor":"cat-prosc-band","className":"is-style-wt-pros-band","layout":{"type":"default"}} --><div class="wp-block-group is-style-wt-pros-band" id="cat-prosc-band"><!-- wp:html --><div class="wt-prosc__item wt-prosc__item--good"><p class="wt-prosc__title">メリット</p><ul><li>日常利用のバランスがよい</li><li>保証窓口が分かりやすい</li></ul></div><div class="wt-prosc__item wt-prosc__item--bad"><p class="wt-prosc__title">デメリット</p><ul><li>大型天板には不向き</li><li>静音性は最上位ではない</li></ul></div><!-- /wp:html --></div><!-- /wp:group -->
...
<!-- wp:group {"anchor":"cat-pr-intro","className":"is-style-wt-pr-intro","layout":{"type":"default"}} --><div class="wp-block-group is-style-wt-pr-intro" id="cat-pr-intro"><!-- wp:html --><p class="wt-pr is-style-wt-pr-intro"><span class="wt-pr__tag">PR</span><span>記事上部で広告を含むことを1文で伝えます。</span></p><!-- /wp:html --></div><!-- /wp:group -->
<!-- wp:group {"anchor":"cat-pr-inline","className":"is-style-wt-pr-inline","layout":{"type":"default"}} --><div class="wp-block-group is-style-wt-pr-inline" id="cat-pr-inline"><!-- wp:html --><span class="wt-pr__tag">PR</span><h3>製品の選び方</h3><!-- /wp:html --></div><!-- /wp:group -->
<!-- wp:group {"anchor":"cat-pr-double","className":"is-style-wt-pr-double","layout":{"type":"default"}} --><div class="wp-block-group is-style-wt-pr-double" id="cat-pr-double"><!-- wp:html --><p class="wt-pr"><span class="wt-pr__tag">PR</span><span>記事冒頭の開示。</span></p><p class="wt-pr"><span class="wt-pr__tag">PR</span><span>記事末尾でも開示を再確認します。</span></p><!-- /wp:html --></div><!-- /wp:group -->
<!-- wp:group {"anchor":"cat-pr-band","className":"is-style-wt-pr-band","layout":{"type":"default"}} --><div class="wp-block-group is-style-wt-pr-band" id="cat-pr-band"><!-- wp:html --><p class="wt-pr is-style-wt-pr-band"><span class="wt-pr__icon" aria-hidden="true">i</span><span class="wt-pr__tag">PR</span><span>広告・報酬の有無をアイコン付き帯で示します。</span></p><!-- /wp:html --></div><!-- /wp:group -->
<!-- wp:group {"anchor":"cat-detext-takeaways","className":"is-style-wt-detext-takeaways","layout":{"type":"default"}} --><div class="wp-block-group is-style-wt-detext-takeaways" id="cat-detext-takeaways"><!-- wp:html --><div class="wt-detext__item"><strong>低さ</strong><p>座り姿勢に合う。</p></div><div class="wt-detext__item"><strong>静音</strong><p>夜でも使いやすい。</p></div><div class="wt-detext__item"><strong>保証</strong><p>長期利用を支える。</p></div><!-- /wp:html --></div><!-- /wp:group -->
...
<!-- wp:group {"anchor":"cat-detext-diagram","className":"is-style-wt-detext-diagram","layout":{"type":"default"}} --><div class="wp-block-group is-style-wt-detext-diagram" id="cat-detext-diagram"><!-- wp:html --><div class="wt-detext__diagram-box">身長</div><span class="wt-detext__diagram-arrow" aria-hidden="true">→</span><div class="wt-detext__diagram-box">机の高さ</div><!-- /wp:html --></div><!-- /wp:group -->
<!-- wp:group {"anchor":"cat-detext-quote","className":"is-style-wt-detext-quote","layout":{"type":"default"}} --><div class="wp-block-group is-style-wt-detext-quote" id="cat-detext-quote"><!-- wp:html --><blockquote><p>「毎日の調整が、思ったより簡単だった」</p><cite>短い引用でレビューの要点を残す例</cite></blockquote><!-- /wp:html --></div><!-- /wp:group -->
