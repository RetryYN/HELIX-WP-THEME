...
/**
 * Title: 応募の流れ（3 ステップ）
 * Slug: helix-wt-page/entry-steps
 * Categories: helix-wt-page
 * Description: 段8（2026-09-06 PO 反応 19 回目 WT-EVT-0287「固定ページ継投で使えるパーツ」）の Claude 案。キャンペーン D で entry-steps 62%。買う → 撮る → 送る の番号付き 3 段。 文言・数値は PoC 用の架空。
 */
$u = get_theme_file_uri( 'assets/img' );
?>
<!-- wp:group {"anchor":"part-entry-steps","className":"wt-part wt-part--entry-steps","align":"full","layout":{"type":"default"}} -->
