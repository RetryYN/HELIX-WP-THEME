...
?>
<!-- wp:image {"sizeSlug":"large","className":"is-style-wt-banner"} --><figure class="wp-block-image size-large is-style-wt-banner"><a href="/lp/"><img src="<?php echo esc_url( $u ); ?>/media-pickup-2.jpg" alt="<?php echo esc_attr__( '無料診断へのバナー: 3 分であなたに合うデスクを提案', 'helix-wt' ); ?>" width="1200" height="675"/></a><figcaption class="wp-element-caption"><?php esc_html_e( '3 分の無料診断で、この記事の 3 製品から合うものを提案します。', 'helix-wt' ); ?></figcaption></figure><!-- /wp:image -->
