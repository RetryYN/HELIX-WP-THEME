...
<section class="wt-home-hero wt-home-hero--cards-carousel" aria-labelledby="home-hero-cards-title"><div class="wt-home-hero__inner"><p class="wt-eyebrow">SERVICE</p><h1 id="home-hero-cards-title">サービスから探す</h1><p class="wt-home-hero__lead">製品・コースをカードで横送りする hero（台帳 v2: cards-carousel 11%）。PoC 用の文言。</p><?php $cta( 'cards' ); ?><div class="wt-hcar" data-wt-carousel><ul class="wt-hcar__track" tabindex="0" aria-label="サービス一覧（横スクロール）"><li class="wt-hcar__item"><a href="/lp/"><img src="<?php echo esc_url( $u ); ?>/case-factory.jpg" alt="" width="640" height="400" loading="eager" decoding="async"><b>業務診断</b><span>2 週間で改善の順番を決める</span></a></li><li class="wt-hcar__item"><a href="/lp/"><img src="<?php echo esc_url( $u ); ?>/case-tax.jpg" alt="" width="640" height="400" loading="eager" decoding="async"><b>仕組みづくり</b><span>台帳・申請・記録を一つの流れに</span></a></li><li class="wt-hcar__item"><a href="/lp/"><img src="<?php echo esc_url( $u ); ?>/case-clinic.jpg" alt="" width="640" height="400" loading="lazy" decoding="async"><b>定着支援</b><span>月 1 回の振り返りで数字を確認</span></a></li><li class="wt-hcar__item"><a href="/category/topic-index/"><img src="<?php echo esc_url( $u ); ?>/media-pickup-4.jpg" alt="" width="640" height="400" loading="lazy" decoding="async"><b>導入事例</b><span>製造・士業・医療の 3 業種</span></a></li><li class="wt-hcar__item"><a href="/lp/"><img src="<?php echo esc_url( $u ); ?>/media-pickup-5.jpg" alt="" width="640" height="400" loading="lazy" decoding="async"><b>資料ダウンロード</b><span>3 分で読める診断ガイド</span></a></li></ul><div class="wt-hcar__nav" hidden><button type="button" data-wt-slide="prev" aria-label="前へ">‹</button><button type="button" data-wt-slide="next" aria-label="次へ">›</button></div></div></div></section>
