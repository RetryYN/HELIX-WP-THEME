...
<p class="wt-eyebrow">CLIENTS</p><h2 id="part-logos-title">取引先・提携（ロゴ枠）</h2><p class="wt-part-logos__lead">導入企業 320 社（PoC 用の架空値）。ロゴ枠は実運用で各社の許諾を得た画像に置き換える。</p><ul class="wt-lp-logo-row wt-part-logos" aria-label="取引先ロゴ枠"><li>LOGO 1</li><li>LOGO 2</li><li>LOGO 3</li><li>LOGO 4</li><li>LOGO 5</li><li>LOGO 6</li><li>LOGO 7</li><li>LOGO 8</li><li>LOGO 9</li><li>LOGO 10</li></ul>
</div>
<!-- /wp:html -->
</div>
<!-- /wp:group -->
