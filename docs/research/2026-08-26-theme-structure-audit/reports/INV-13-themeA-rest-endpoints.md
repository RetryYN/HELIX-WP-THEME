...
生ソースの証跡ギャップは `evidence/re-themeA-rest.txt` の採取で解消した（route 登録 3675 / 3780、
権限 3680 / 3785、サーバー側取得 3796、Warning 発生箇所 3726）。未認証到達性と本文 §1-2 の結論は
自サイト GET で確定し、既存本文と矛盾しない。詳細は証跡ファイルと finding #21 を参照し、本節では再叙述しない。
