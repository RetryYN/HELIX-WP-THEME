...
| テーマ | ゾーン数 | 主なゾーン |
|---|---|---|
| JIN:R | 11 ウィジェットエリア | post-top / post-start / post-end / post-bottom / relatedpost-bottom / **sidebar-tracking**（追尾）/ hamburger / toppage / footer |
| SWELL | 24 ウィジェットエリア | single_top / single_bottom / **single_cta** / before_related / after_related / **fix_sidebar** / fix_bottom_menu / head_box / footer_box1-3 |
...
## 完了条件
- [ ] 正規化ゾーン一覧（意味 × JIN:R 名 × SWELL 名 × 実使用有無）が存在する
