...
静的検査は `bin/check-design-consistency.sh` をそのまま実行し、出力に6ゲートと `FAIL=0` があることを確認する。G-E1 は `docs/research/2026-08-29-ge1-local/editor-validate-2026-08-29.json` の71行を再集計し、invalidブロックが0であることを確認する。認証情報、接続先、外部送信は証跡へ書かない。
