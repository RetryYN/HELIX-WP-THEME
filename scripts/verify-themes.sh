...
THEME_A_META_PREFIX="${THEME_A_META_PREFIX:-_${THEME_A_SLUG}_}"
...
export THEME_A_SLUG THEME_A_OPTION_PREFIX THEME_A_META_PREFIX THEME_B_SLUG THEME_B_OPTION_KEY THEME_B_OPTION_PREFIX THEME_B_REST_NS THEME_B_BLOCK_NS
