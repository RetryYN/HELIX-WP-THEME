...
const trackedSources=['scripts/verify-content-inheritance.mjs',...['functions.php','inc/content-faces.php','inc/learning.php','inc/site-pages.php','inc/content-chrome.php','config/content-chrome.json','theme.json','assets/css/theme.css','assets/css/content-faces.css','assets/css/site-pages.css','assets/css/content-chrome.css','assets/js/header.js','assets/js/footer.js','assets/js/side.js','parts/header-band.html','parts/header-center.html','parts/header-two-rows.html','parts/footer.html'].map(f=>'docs/research/2026-09-05-design-prototype-03/theme/helix-wt/'+f),'docs/research/2026-09-08-content-faces/plugin/content-faces.php','docs/research/2026-09-08-content-faces/plugin/manifest.json'];
