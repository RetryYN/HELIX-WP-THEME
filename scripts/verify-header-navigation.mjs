...
const sources=['docs/research/2026-09-05-design-prototype-03/theme/helix-wt/inc/search.php','scripts/verify-header-navigation.mjs',...['inc/footer-navigation.php','parts/footer.html','patterns/footer-sitemap.php','patterns/footer-related.php','functions.php','inc/content-chrome.php','inc/content-navigation.php','assets/css/content-chrome.css','parts/header.html','parts/header-band.html','patterns/header-sp-extras.php'].map(f=>'docs/research/2026-09-05-design-prototype-03/theme/helix-wt/'+f)];
