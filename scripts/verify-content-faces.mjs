...
const sources = ['scripts/verify-content-faces.mjs', 'scripts/start-content-lab.py', ...['functions.php','inc/content-faces.php','inc/footer-navigation.php','parts/footer.html','patterns/footer-sitemap.php','patterns/footer-related.php','assets/css/content-faces.css'].map(p=>'docs/research/2026-09-05-design-prototype-03/theme/helix-wt/'+p)];
...
if (!contentLab.credentialsFile) throw Error('WTCF_LAB_CREDENTIALS must point to the external lab credentials file');
