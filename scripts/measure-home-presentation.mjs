...
try{
 for(const [device,width]of [['pc',1440],['sp',375]])for(const version of ['before','after']){
  ...
  const page=await context.newPage();await page.goto(`${contentLab.baseUrl}/?wt=home_hero:split,home_sections:service,home_side_layout:right,side_from:below-hero,home_fixed:sp-bottom-bar,home_fix:own,home_contact:double-cta`);
