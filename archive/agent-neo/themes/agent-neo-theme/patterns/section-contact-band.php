...
<div id="contact" class="wp-block-group alignfull an-section an-section--contact-band has-background-color has-accent-aa-background-color has-text-color has-background" style="padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--40)">
...
<!-- wp:heading {"textColor":"background","style":{"typography":{"fontWeight":"800"}},"fontSize":"x-large"} -->
