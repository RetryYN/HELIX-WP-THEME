...
/*
 * アクセシビリティ注記（WCAG 2.1 達成基準 1.4.3 意図的例外）:
 * Facebook #1877f2 / LINE #06c755 / はてブ #00a4de は各 SNS 公式ブランドカラー。
 * コントラスト比（白文字）: Facebook 4.23:1 / LINE 2.25:1 / はてブ 2.85:1
 * ブランドガイドラインへの準拠を優先し色変更は行わない。
 * X（黒 #000000 / 白文字 21:1）は AA 合格。
 * 詳細は style.css の「SNS シェアボタン — ブランド色の意図的 WCAG 例外」セクション参照。
 */
