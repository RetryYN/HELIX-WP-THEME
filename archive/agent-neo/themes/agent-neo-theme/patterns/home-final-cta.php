...
<div class="wp-block-button an-cta an-cta--final_primary"><a class="wp-block-button__link has-accent-aa-color has-text-color has-background has-custom-font-size wp-element-button" href="#" style="border-radius:6px;background-color:var(--wp--preset--color--background);padding-top:1rem;padding-right:2.5rem;padding-bottom:1rem;padding-left:2.5rem;font-size:1.0625rem;font-weight:700"><?php esc_html_e( '導入をはじめる →', 'agent-neo' ); ?></a></div>
<!-- /wp:button -->
...
<div class="wp-block-button is-style-outline an-cta an-cta--final_pricing"><a class="wp-block-button__link has-background-color has-text-color has-border-color has-custom-font-size wp-element-button" href="#" style="border-color:var(--wp--preset--color--background);border-width:2px;border-radius:6px;padding-top:1rem;padding-right:2.5rem;padding-bottom:1rem;padding-left:2.5rem;font-size:1.0625rem;font-weight:700"><?php esc_html_e( '料金を見る', 'agent-neo' ); ?></a></div>
<!-- /wp:button -->
