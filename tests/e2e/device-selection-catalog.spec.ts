...
for (const [device, width] of [['pc', 1440], ['sp', 375]] as const) {
  test(`finished DEVICE selection, comparison facts and saved reason / ${device}`, async ({ page }) => {
    ...
    await page.screenshot({ path:`docs/research/2026-09-16-device-vocabulary/catalog-${device}.png`, fullPage:true });
